...
*/}}
{{- define "encryption-service.name" -}}
...
*/}}
{{- define "encryption-service.fullname" -}}
...
*/}}
{{- define "encryption-service.chart" -}}
...
*/}}
{{- define "encryption-service.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "encryption-service.fullname" .) .Values.serviceAccount.name }}
{{- else }}
